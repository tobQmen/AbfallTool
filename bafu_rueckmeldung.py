"""Rückmeldung ans BAFU: Excel mit auffälligen Koordinaten und Testdatensätzen.

Aufruf:
    python bafu_rueckmeldung.py                      # schreibt rueckmeldung_bafu.xlsx
    python bafu_rueckmeldung.py --xlsx datei.xlsx --db abfallanlagen.db
...
def main():
    ...
    ap.add_argument("--xlsx", default="rueckmeldung_bafu.xlsx")
    args = ap.parse_args()
